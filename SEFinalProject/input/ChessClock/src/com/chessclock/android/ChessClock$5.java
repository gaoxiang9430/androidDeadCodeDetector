...
class ChessClock$5 implements java.lang.Runnable
{
    final ChessClock this$0;

    ChessClock$5(ChessClock  r1)
    {
    ...
    public void run()
    {
        ...
        Button r30, r33, r36;
        r9 = (TextView) this$0.findViewById(2131165187);
        r4 = "";
        ...
        label_0:
        {
            if (ChessClock.access$3(this$0).equals(ChessClock.access$4()) != false)
            {
                if (ChessClock.access$5(this$0) == false)
                {
                    ...
                    r19 = this$0;
                    ChessClock.access$22(r19, ChessClock.access$21(r19) + (long) (ChessClock.access$8(this$0) * 1000));
                    break label_0;
                }
            }
            ...
            if (ChessClock.access$3(this$0).equals(ChessClock.access$10()) != false)
            {
                if (ChessClock.access$5(this$0) == false)
                {
                    ...
                    r77 = this$0;
                    ChessClock.access$22(r77, ChessClock.access$21(r77) + 100L);
            ...
            if (ChessClock.access$3(this$0).equals(ChessClock.access$10()) != false)
            {
                if (ChessClock.access$5(this$0) != false)
                {
                    if (ChessClock.access$12(this$0) > 0)
                    {
                        ...
                        r94 = this$0;
                        ChessClock.access$22(r94, ChessClock.access$21(r94) + 100L);
                    }
        ...
        r23 = this$0;
        ChessClock.access$22(r23, ChessClock.access$21(r23) - 100L);
        l3 = ChessClock.access$21(this$0);
        i4 = (int) (l3 / 1000L);
        i5 = i4 / 60;
        i16 = i4 % 60 + 1;
        ...
        else
        {
            ...
            ChessClock.access$18(this$0).postDelayed(ChessClock.access$23(this$0), 500L);
        }
    }
}
